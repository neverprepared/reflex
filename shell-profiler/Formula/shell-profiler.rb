class ShellProfiler < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/neverprepared/agentic/releases/download/shell-profiler/v#{version}/shell-profiler-v#{version}-darwin-arm64.tar.gz"
      sha256 "a65e216ededcbaf79c730f30b754e4fc248d06cae0307ea3d7d1f1cf5e0e7730" # darwin-arm64
    end
    if Hardware::CPU.intel?
      url "https://github.com/neverprepared/agentic/releases/download/shell-profiler/v#{version}/shell-profiler-v#{version}-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/neverprepared/agentic/releases/download/shell-profiler/v#{version}/shell-profiler-v#{version}-linux-arm64.tar.gz"
      sha256 "88488a5efb3963790bac9a69eeb1c831da7a26f3f2106cf5797046aa7f96d9c7" # linux-arm64
    end
    if Hardware::CPU.intel?
      url "https://github.com/neverprepared/agentic/releases/download/shell-profiler/v#{version}/shell-profiler-v#{version}-linux-amd64.tar.gz"
